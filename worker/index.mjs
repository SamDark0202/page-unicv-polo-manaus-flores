const API_ROUTE_LOADERS = new Map([
  ["/api/admin-audit-logs", () => import("../api-server/admin-audit-logs.js")],
  ["/api/admin-commissions", () => import("../api-server/admin-commissions.js")],
  ["/api/admin-indications", () => import("../api-server/admin-indications.js")],
  ["/api/admin-partner-access", () => import("../api-server/admin-partner-access.js")],
  ["/api/admin-partners", () => import("../api-server/admin-partners.js")],
  ["/api/admin-session", () => import("../api-server/admin-session.js")],
  ["/api/admin-users", () => import("../api-server/admin-users.js")],
  ["/api/cursos", () => import("../api-server/cursos.js")],
  ["/api/imagekit-upload", () => import("../api-server/imagekit-upload.js")],
  ["/api/partner-public-lead", () => import("../api-server/partner-public-lead.js")],
  ["/api/tecnico-competencia-lead", () => import("../api-server/tecnico-competencia-lead.js")],
  ["/api/vocacional-lead", () => import("../api-server/vocacional-lead.js")],
  ["/api/webhooks", () => import("../api-server/webhooks.js")],
]);
